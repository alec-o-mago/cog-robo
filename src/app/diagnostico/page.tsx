...
export default function Diagnostico() {
  ...
  return (
    ...
    <div className={`w-[892px] h-[154px] left-[477px] top-[141px] absolute transition-all duration-100 ${fade1 ? "opacity-100" : "opacity-0"}`}>
        <div className="w-[892px] h-[154px] left-0 top-0 absolute rounded-[5px] border border-sky-200 blur-[1px]" />
        <div className="w-[794px] h-[89px] left-[64.29px] top-[44px] absolute text-white text-[22px] font-normal font-['Roboto Mono']">Olá! Sou o Robô Cognitivo e vamos falar sobre a maturidade analítica da sua empresa. :]</div>
    </div>
    <div className={`w-[892px] h-[177px] left-[477px] top-[325px] absolute transition-all duration-900 ${fade2 ? "opacity-100" : "opacity-0"}`}>
        <div className="w-[892px] h-[177px] left-0 top-0 absolute rounded-[5px] border border-sky-200 blur-[1px]"/>
        <div className="w-[794px] h-[111px] left-[49px] top-[40px] absolute text-white text-[22px] font-normal font-['Roboto Mono']">Para esta entrevista vamos passar por diversos temas, como por exemplo: Cultura, tomada de decisão, papéis e responsabilidades e liderança.</div>
    </div>
    <div className={`w-[892px] h-[135px] left-[477px] top-[532px] absolute transition-all duration-900 ${fade3 ? "opacity-100" : "opacity-0"}`}>
    ...
    <button className="w-[396px] left-[460px] top-[707px] absolute border border-black justify-start items-start gap-4 inline-flex" onClick={handleVoltar}>
        <div className="grow shrink basis-0 h-16 px-[30px] py-5 rounded-[900px] border border-white border-opacity-50 justify-center items-center gap-[15px] flex">
            <div className="text-white text-opacity-50 text-base font-bold font-['Roboto Mono'] leading-normal">&lt;&lt;&lt; Voltar</div>
        </div>
    </button>
